-- Update Bootstrap RPC to include Google Places Data
DROP FUNCTION IF EXISTS api_v1_bootstrap_organization(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, UUID, TEXT, DOUBLE PRECISION, DOUBLE PRECISION);
...
BEGIN
    ...
    -- Lookup Business Type from Config (reusing existing logic)
    ...
    -- 1. Create Organization with Identity + Google Params
    INSERT INTO public.organizations (
        ...
        opening_hours,    -- New
        photos,           -- New
        website_url       -- Update if provided
    )
    VALUES (
        p_org_name, 
        p_official_name, 
    ...
    -- 1.5 Create Location (Keep existing logic for PostGIS)
