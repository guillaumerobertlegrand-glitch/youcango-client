-- Drop potential ambiguous functions to clean state
DROP FUNCTION IF EXISTS api_v1_get_merchants(double precision, double precision, text, text[], integer);
DROP FUNCTION IF EXISTS api_v1_get_merchants(double precision, double precision, text, text[], integer, text);

-- Re-create the ONE true function
