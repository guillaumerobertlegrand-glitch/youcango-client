-- FIX: Persistent Schema Cache Error
-- Strategy: Rename function to v2 to bypass cache/ambiguity permanently.

CREATE OR REPLACE FUNCTION api_v1_bootstrap_organization_v2(
    p_org_name TEXT, 
    p_first_name TEXT,
    p_last_name TEXT,
    p_job_title TEXT,
...
DECLARE
    ...
    v_google_id TEXT := p_google_place_id; -- Local copy
    v_hours JSONB := p_opening_hours;
    v_photos JSONB := p_photos;
    v_site TEXT := p_website;
BEGIN
    v_user_id := auth.uid();
