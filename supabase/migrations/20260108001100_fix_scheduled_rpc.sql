-- FIX: Allow 'scheduled' state for Delayed Intents in RPC
-- Previously forced 'locking' for everything, breaking delayed demos.
...
BEGIN
    ...
    IF p_intent_mode = 'delayed' AND p_scheduled_at IS NOT NULL THEN
        v_initial_state := 'scheduled';
    ELSE
        v_initial_state := 'locking';
    END IF;
