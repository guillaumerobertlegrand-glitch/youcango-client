-- FIX: Typo in V4 RPC (prefix -> ape_prefix)
-- Supersedes 20260120141500_create_bootstrap_v4.sql logic
...
BEGIN
    ...
    -- FIX: Use correct column name 'ape_prefix' instead of undefined 'prefix'
...
GRANT EXECUTE ON FUNCTION api_create_org_v4(JSONB) TO anon, authenticated, service_role;
