-- Unify Create Session State
-- Always start in 'locking' state to trigger Pro P2 immediately, regardless of intent mode.
...
BEGIN
    ...
    INSERT INTO public.sessions (
        ...
        monetization_model,
        arrival_timing,
        state, -- ALWAYS LOCKING INITIALLY
        slot_id,
        service_requested,
